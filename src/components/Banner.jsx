...
export default function Banner() {
  return (
    <div className="relative bg-white rounded-4xl p-6 w-full text-sm shadow-xl flex flex-col justify-between h-full">
      ...
      <div className="absolute top-4 left-4 border-r-2 border-gray-300 bottom-4 right-1/2 rounded-3xl p-6 shadow-md z-10 bg-[#bc68cf13] backdrop-blur-lg flex flex-col justify-between">
        ...
        <ul className="space-y-2 mt-3 text-gray-800 text-md font-semibold mb-5">
      ...
      <div className="flex justify-end mt-5">
        <span
          className=" flex items-center gap-2 text-white rounded-3xl py-3 text-lg  px-4"
          style={{ background: "#C49A6C" }}
        >
          Contact us
        </span>
        <FaAngleRight className="text-white bg-[#C49A6C] rounded-full text-5xl p-3 " />
      </div>
    </div>
  );
}
